                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-sm btn-default col-sm-3" type="button"
                                        onclick="$('#manage-menu').get(0).reset()">No</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary edit_menu" type="button"
                                            ...
                                            data-img_path="<?php echo $row['img_path'] ?>">Editar</button>
...
$('.delete_menu').click(function() {
    _conf("Estas seguro de eliminar el producto?", "delete_menu", [$(this).attr('data-id')])
})
