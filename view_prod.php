        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="input-group col-md-7 mb-3">
                    ...
                    <div class="input-group-prepend">
                        <button class="btn btn-outline-secondary" type="button" id="qty-plus" x><span
                                class="fa fa-plus"></span></button>
                    </div>
                </div>
            </div>
            <div class="text-center">
                <button class="btn btn-primary btn-sm btn-block" id="add_to_cart_modal"><i class="fa fa-cart-plus"></i>
                    Añadir</button>
            </div>
        </div>
...
$('#add_to_cart_modal').click(function() {
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp == 1)
                alert_toast("Se agrego el producto al carrito");
