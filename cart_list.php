     ...
     <div class="container h-100">
         <div class="row h-100 align-items-center justify-content-center text-center">
             <div class="col-lg-10 align-self-end mb-4 page-title">
                 <h3 class="text-white">Listas del Carrito <i class="fas fa-cart-plus"></i>
                 </h3>
             ...
             <div class="col-lg-8">
                 <div class="sticky">
                     <div class="card">
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-8"><b>Mis Compras</b></div>
                     ...
                     <div class="card-body">
                         <div class="row">
                             <div class="col-md-4" style="text-align: -webkit-center">
                                 <a href="javascript:void(0)" class="rem_cart btn btn-sm btn-danger"
                                     data-id="<?php echo $row['id'] ?>" id="delete_cart" onclick="delete_cart()"><i
                             ...
                             <div class="col-md-4">
                                 ...
                                 <p> <b><small>Precio Unitario :<?php echo number_format($row['price'],2) ?></small></b>
                                 </p>
             ...
             <div class="col-md-4">
                 <div class="sticky">
                     <div class="card">
                         <div class="card-body">
                             <p>
                                 <large>Total Pagar</large>
                             </p>
                             <hr>
                             <p class="text-right"><b><?php echo number_format($total,2) ?></b></p>
                             <hr>
                             <select class="form-select form-select-lg btn-primary text-white"
                                 aria-label=".form-select-lg example" style="background:black">
                                 <option selected>Seleccionar Metodo
                                     de Pago</option>
                                 <a href="#">
                                     <option value="1" data-toggle="modal" data-target="#pagarcompra2" id="checkout">
                                         Consumidor Final
                                     </option>
                                 </a>
                                 <a href="#">
                                     <option value="2" data-toggle="modal" data-target="#pagarcompra" id="checkout2">Via
                                         Paypal
                                     </option>
                                 </a>
                                 ...
                                 <!-- <div class="text-center">
                                     <button class="btn btn-block btn-danger" type="button" id="checkout">Procer a
                                         Pagar</button>-->
...
$('#checkout').click(function() {
    if ('<?php echo isset($_SESSION['login_user_id']) ?>' == 1) {
        ...
        uni_modal("Inicar Sesion", "login.php?page=checkout")
    }
})

$('#checkout2').click(function() {
    if ('<?php echo isset($_SESSION['login_user_id']) ?>' == 1) {
        location.replace("index.php?page=pagar")
    } else {
        uni_modal("Inicar Sesion", "login.php?page=pagar")
    }
})
 </script>